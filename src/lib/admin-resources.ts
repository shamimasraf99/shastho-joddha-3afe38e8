...
export const resources: Record<string, ResourceDef> = {
  articles: {
    ...
    fields: [
      ...
      { key: "cover_image", label: "কভার ছবি URL", type: "image" },
  ...
  news: {
    table: "articles",
    title: "স্বাস্থ্য সংবাদ / স্বাস্থ্যকোষ",
    singular: "পোস্ট",
    orderBy: { column: "created_at", ascending: false },
    searchColumn: "title",
    ...
    fields: [
      ...
      {
        key: "article_type",
        label: "বিভাগ (কোথায় দেখাবে)",
        type: "select",
        required: true,
        options: [
          { value: "news", label: "স্বাস্থ্য সংবাদ" },
          { value: "encyclopedia", label: "স্বাস্থ্য কোষ" },
        ],
      },
      { key: "tags", label: "ট্যাগ (কমা দিয়ে)", type: "tags" },
      { key: "meta_title", label: "Meta Title", type: "text" },
  ...
  doctors: {
    ...
    fields: [
      ...
      { key: "photo", label: "ছবি URL", type: "image" },
  ...
  hospitals: {
    ...
    fields: [
      ...
      { key: "image", label: "ছবি URL", type: "image" },
      { key: "description", label: "বিবরণ", type: "textarea" },
      { key: "is_active", label: "সক্রিয়", type: "boolean" },
    ],
  },
  ...
  videos: {
    ...
    fields: [
      { key: "title", label: "শিরোনাম", type: "text", required: true },
      { key: "youtube_id", label: "YouTube ভিডিও ID বা লিংক", type: "text", required: true, placeholder: "যেমন: dQw4w9WgXcQ অথবা https://youtu.be/dQw4w9WgXcQ" },
      { key: "thumbnail", label: "থাম্বনেইল URL", type: "image" },
      { key: "category", label: "ক্যাটাগরি", type: "text" },
      { key: "description", label: "বিবরণ", type: "textarea" },
      { key: "autoplay", label: "অটোপ্লে চালু", type: "boolean" },
      { key: "is_published", label: "প্রকাশিত", type: "boolean" },
    ],
  },
  podcasts: {
    ...
    fields: [
      { key: "title", label: "শিরোনাম", type: "text", required: true },
      { key: "description", label: "বিবরণ", type: "textarea" },
      { key: "youtube_link", label: "YouTube লিংক বা ভিডিও ID", type: "text", placeholder: "https://youtu.be/... অথবা ভিডিও ID" },
  ...
  advertisements: {
    ...
    fields: [
      { key: "title", label: "শিরোনাম", type: "text", required: true },
      {
        ...
        required: true,
        options: [
          { value: "header_bar", label: "হেডার বার এডস" },
          { value: "top_banner", label: "টপ ব্যানার" },
          { value: "sidebar", label: "সাইডবার" },
          { value: "article", label: "আর্টিকেলে" },
          { value: "popup", label: "পপআপ" },
        ],
      },
      { key: "image_url", label: "ছবি URL", type: "image" },
  ...
  seo: {
    ...
    fields: [
      ...
      { key: "og_image", label: "OG ছবি URL", type: "image" },
